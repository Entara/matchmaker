...
GV.Config.basicURL = "http://ibr.spatialhumanities.de/test2/"; // server spatialstore (test2)
GV.Config.viewer = GV.Config.basicURL + "viewer/";
//GV.Config.spatialstore = GV.Config.basicURL + "spatialstore/";//EXTERNAL_SERVER_ADDRESS
GV.Config.spatialstore = GV.Config.basicURL; // test2
